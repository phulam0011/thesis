...
export default function Home() {
  ...
  async function queryData(data: any) {
    const response = await fetch(
      "https://eoa36tkqbq14r20u.eu-west-1.aws.endpoints.huggingface.cloud",
      {
        headers: {
          "Authorization": "Bearer XjUjGEvpKuxPhqLLPDzEAXJYbnXjEqYGXPgUfCkumPJZJKjAbnafOEflCyGiqNirKAFeWZbckxHyviyRwQOtlKFKOEEBzhlaqanqGSLWRNnyAUrMAIKHDhdStTkikDMB", 
